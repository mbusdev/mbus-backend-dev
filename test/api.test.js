...
describe('API Endpoints', () => {
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const response = yield axios.get(`${BASE_URL}/getBusPositions`);
    ...
    it('should get bus positions and confirm structure', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/getBusPositions`);
    ...
    it('should get vehicle positions (alias for bus positions) and confirm structure', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/getVehiclePositions`);
        expect(response.status).toBe(200);
        expect(response.data).toHaveProperty('buses');
        expect(Array.isArray(response.data.buses)).toBe(true);
        console.log(`GET /getVehiclePositions: ${response.data.buses.length} vehicles found.`);
    }));
    it('should get selectable routes and confirm structure', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/getSelectableRoutes`);
        expect(response.status).toBe(200);
    ...
    it('should get all cached routes and confirm structure', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/getAllRoutes`);
        expect(response.status).toBe(200);
    ...
    it('should get all bus predictions and log stop IDs', () => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    it('should get predictions for a specific stop ID (if available)', () => __awaiter(void 0, void 0, void 0, function* () {
        const testStopId = 'M313';
        const response = yield axios.get(`${BASE_URL}/getStopPredictions/${testStopId}`);
        expect(response.status).toBe(200);
        expect(response.data).toHaveProperty('bustime-response');
    ...
    it('should get predictions for a specific bus ID (if available)', () => __awaiter(void 0, void 0, void 0, function* () {
        const testBusId = '341';
        const response = yield axios.get(`${BASE_URL}/getBusPredictions/${testBusId}`);
        expect(response.status).toBe(200);
        expect(response.data).toHaveProperty('bustime-response');
        expect(response.data['bustime-response']).toHaveProperty('prd');
        expect(Array.isArray(response.data['bustime-response'].prd)).toBe(true);
    ...
    it('should get route information', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/getRouteInformation`);
        expect(response.status).toBe(200);
    ...
    it('should get all stops', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/getAllStops`);
        expect(response.status).toBe(200);
    ...
    it('should get building locations (assuming it serves a JSON file)', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/getBuildingLocations`);
        expect(response.status).toBe(200);
    ...
    it('should get startup messages', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios.get(`${BASE_URL}/get-startup-messages`);
        expect(response.status).toBe(200);
    ...
    // --- Image Endpoint ---
    it('should get a vehicle image for a valid route', () => __awaiter(void 0, void 0, void 0, function* () {
        const testRoute = 'CN';
        const response = yield axios.get(`${BASE_URL}/getVehicleImage/${testRoute}`, { responseType: 'arraybuffer' }); // Expect binary data
        expect(response.status).toBe(200);
    ...
    it('should return 400 for an invalid vehicle image route', () => __awaiter(void 0, void 0, void 0, function* () {
        const invalidRoute = 'INVALID_ROUTE';
        try {
            yield axios.get(`${BASE_URL}/getVehicleImage/${invalidRoute}`);
    ...
    it('should get path between main stops', () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response2 = yield axios.get(`${BASE_URL}/plan-journey?originLat=42.27389558&originLon=-83.73739576&destLat=42.29303061&destLon=-83.7163671`);
    ...
    it('should return 400 for missing coordinates in plan-journey', () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield axios.get(`${BASE_URL}/plan-journey?originLat=42.264356&originLon=-83.744353999999`); // Missing destLat, destLon
